...
var O365Discovery = require('cordova-plugin-ms-files.DiscoveryServices');
        ...
        var CollectionQuery = (function () {
            ...
            CollectionQuery.prototype.select = function (selection) {
                if (typeof selection === 'string') {
                    ...
                    throw new Exception('\'select\' argument must be string or string[].');
                }
                return this;
            };
            ...
            CollectionQuery.prototype.expand = function (expand) {
                if (typeof expand === 'string') {
                    ...
                    throw new Exception('\'expand\' argument must be string or string[].');
                }
                return this;
            };
            ...
            CollectionQuery.prototype.orderBy = function (orderBy) {
                if (typeof orderBy === 'string') {
                    ...
                    throw new Exception('\'orderBy\' argument must be string or string[].');
                }
                return this;
            };
            ...
            CollectionQuery.prototype.fetchAll = function (maxItems) {
                var path = this.path + (this._query ? (this.path.indexOf('?') < 0 ? '?' : '&') + this._query : ""),
                    pagedItems = new Extensions.PagedCollection(this.context, path, this._resultFn),
                    accumulator = [],
                    deferred = new Deferred(),
                    recursive = function (nextPagedItems) {
                    if (!nextPagedItems) {
...
(function (MS) {
    ...
    var SharePointClient = (function () {
        function SharePointClient(serviceRootUri, adalAuthContext, resourceId, appId, redirectUrl) {
            this._context = new MS.Extensions.DataContext(serviceRootUri, undefined, 
                O365Discovery.Context.prototype.getAccessTokenFn.call(this, adalAuthContext, resourceId, appId, redirectUrl));
        }
    ...
    (function (FileServices) {
        ...
        var FileSystemItem = (function (_super) {
            ...
            FileSystemItem.prototype.update = function () {
                var _this = this;
                var deferred = new Deferred(), request = new MS.Extensions.Request(this.path);
                ...
                this.context.request(request).then(function (data) {
                    var parsedData = JSON.parse(data),
                        path = parsedData.d['__metadata']['id'];
        ...
        var FileFetcher = (function (_super) {
            ...
            FileFetcher.prototype.download = function () {
                var deferred = new Deferred(), request = new MS.Extensions.Request(this.getPath("Download"));
            ...
            FileFetcher.prototype.copyTo = function (target, overwrite) {
                    var deferred = new Deferred(),
                        request = new MS.Extensions.Request(this.getPath("CopyTo"));
            ...
            FileFetcher.prototype.deleteObject = function () {
                var deferred = new Deferred(), request = new MS.Extensions.Request(this.getPath("DeleteObject"));
            ...
            FileFetcher.prototype.moveTo = function (target, overwrite) {
                var deferred = new Deferred(), request = new MS.Extensions.Request(this.getPath("MoveTo"));
            ...
            FileFetcher.prototype.upload = function (stream) {
                var deferred = new Deferred(), request = new MS.Extensions.Request(this.getPath("Upload"));
        ...
        var File = (function (_super) {
            ...
            File.prototype.copyTo = function (target, overwrite) {
                var deferred = new Deferred(), request = new MS.Extensions.Request(this.getPath("CopyTo"));
            ...
            File.prototype.upload = function (stream) {
                var deferred = new Deferred(),
                    request = new MS.Extensions.Request(this.getPath("Upload"));
        ...
        var FileSystemItems = (function (_super) {
            ...
            function FileSystemItems(context, path, entity) {
                ...
                this._parseCollectionFn = function (context, data) {
                    var pathFn = function (data) {
                        //return this.context.serviceRootUri + '/fileSystemItems' + EncodingHelpers.getKeyExpression([{ name : "Id", type : "Edm.String", value : data.d.Id }]);
            ...
            FileSystemItems.prototype.getFileSystemItem = function (Id) {
                var path = this.path + EncodingHelpers.getKeyExpression([{ name: "Id", type: "Edm.String", value: Id }]);
            ...
            FileSystemItems.prototype.addFileSystemItem = function (item) {
                ...
                if (this.entity == null) {
                    ...
                    this.context.request(request).then((function (data) {
                        var parsedData = JSON.parse(data),
                            objectPath = parsedData.d['__metadata']['id'];
            ...
            FileSystemItems.prototype.asFiles = function () {
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        //return this.context.serviceRootUri + '/files' + EncodingHelpers.getKeyExpression([{ name : "Id", type : "Edm.String", value : data.Id }]);
                        return data['__metadata']['id'];
                    };
            ...
            FileSystemItems.prototype.asFolders = function () {
                var parseCollectionFn = (function (context, data) {
                    var pathFn = function (data) {
                        //return this.context.serviceRootUri + '/folders' + EncodingHelpers.getKeyExpression([{ name : "Id", type : "Edm.String", value : data.Id }]);
                        return data['__metadata']['id'];
                    };
            ...
            FileSystemItems.prototype.getById = function (id) {
                var _this = this;
                var deferred = new Deferred(),
                    request = new MS.Extensions.Request(this.path + EncodingHelpers.getKeyExpression([{ name: "Id", type: "Edm.String", value: id }]));

                request.method = 'GET';

                this.context.request(request).then((function (data) {
                    var parsedData = JSON.parse(data);
                    var path = parsedData.d['__metadata']['id'];
